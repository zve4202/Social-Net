...
using Stihi.ru.Blazor.Server.Services;
...
namespace Stihi.ru.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<ruBlazorApplication>(Configuration);
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "Stihi.ru API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the Stihi.ru.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
                    ...
                    Flows = new OpenApiOAuthFlows() {
                        AuthorizationCode = new OpenApiOAuthFlow() {
                            ...
                            Scopes = new Dictionary<string, string> {
                                ...
                                { @"[Enter the scope name in the Stihi.ru.Blazor.Server\Startup.cs file]", @"[Enter the scope description in the Stihi.ru.Blazor.Server\Startup.cs file]" }
                            }
                        }
                    }
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if(env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Stihi.ru WebApi v1");
