...
namespace Stihi.ru.Blazor.Server {
    public partial class ruBlazorApplication : BlazorApplication {
        public ruBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void ruBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
