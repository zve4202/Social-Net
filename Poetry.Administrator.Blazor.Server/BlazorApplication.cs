...
namespace Poetry.Administrator.Blazor.Server {
    public partial class AdministratorBlazorApplication : BlazorApplication {
        public AdministratorBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void AdministratorBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
